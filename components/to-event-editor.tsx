      ...
      <div className="space-y-3">
        ...
        {eventType === "key_code" && (
          <div className="space-y-2">
            ...
            <Select value={event.key_code || ""} onValueChange={(key) => onUpdate({ ...event, key_code: key })}>
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  onUpdate({
                    ...event,
                    set_variable: { ...(event.set_variable || { value: 1 }), name: e.target.value },
                  })
                }
        ...
        {eventType === "select_input_source" && (
          <div className="space-y-2">
            ...
            <Input
              ...
              className="text-xs"
            />
            <p className="text-xs text-muted-foreground">Example: en, ja, zh-Hans</p>
          </div>
        )}
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  onUpdate({
                    ...event,
                    mouse_key: { ...(event.mouse_key || {}), x: Number.parseInt(e.target.value) || 0 },
                  })
                }
                className="text-xs"
              />
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  onUpdate({
                    ...event,
                    mouse_key: { ...(event.mouse_key || {}), y: Number.parseInt(e.target.value) || 0 },
                  })
                }
                className="text-xs"
              />
        ...
        <ModifierSelector
          ...
          onChange={(modifiers) => onUpdate({ ...event, modifiers: modifiers.length > 0 ? modifiers : undefined })}
          ...
          <CollapsibleContent className="space-y-3 pt-2">
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => onUpdate({ ...event, lazy: checked === true ? true : undefined })}
              />
              <Label htmlFor={`lazy-${event.key_code}`} className="text-xs cursor-pointer">
                Lazy (modifier flag)
              </Label>
            </div>
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => onUpdate({ ...event, repeat: checked === false ? false : undefined })}
              />
              <Label htmlFor={`repeat-${event.key_code}`} className="text-xs cursor-pointer">
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => onUpdate({ ...event, halt: checked === true ? true : undefined })}
              />
              <Label htmlFor={`halt-${event.key_code}`} className="text-xs cursor-pointer">
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                onChange={(e) => {
                  ...
                  onUpdate({ ...event, hold_down_milliseconds: value > 0 ? value : undefined })
                }}
                placeholder="0"
                className="text-xs"
              />
